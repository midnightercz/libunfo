...
int unfo_doc_update_from_set_u(UNFO_Object *obj, const char *val);
int unfo_doc_update_status_set(UNFO_DocUpdate *obj, const char *val);
int unfo_doc_update_status_set_u(UNFO_Object *obj, const char *val);
int unfo_doc_update_type_set(UNFO_DocUpdate *obj, const char *val);
int unfo_doc_update_type_set_u(UNFO_Object *obj, const char *val);
int unfo_doc_update_id_set(UNFO_DocUpdate *obj, const char *val);
int unfo_doc_update_id_set_u(UNFO_Object *obj, const char *val);
int unfo_doc_update_title_set(UNFO_DocUpdate *obj, const char *val);
int unfo_doc_update_title_set_u(UNFO_Object *obj, const char *val);
int unfo_doc_update_version_set(UNFO_DocUpdate *obj, const char *val);
int unfo_doc_update_version_set_u(UNFO_Object *obj, const char *val);
int unfo_doc_update_rights_set(UNFO_DocUpdate *obj, const char *val);
int unfo_doc_update_rights_set_u(UNFO_Object *obj, const char *val);
int unfo_doc_update_summary_set(UNFO_DocUpdate *obj, const char *val);
int unfo_doc_update_summary_set_u(UNFO_Object *obj, const char *val);
int unfo_doc_update_description_set(UNFO_DocUpdate *obj, const char *val);
int unfo_doc_update_description_set_u(UNFO_Object *obj, const char *val);
int unfo_doc_update_solution_set(UNFO_DocUpdate *obj, const char *val);
int unfo_doc_update_solution_set_u(UNFO_Object *obj, const char *val);

char* unfo_doc_update_from_get(UNFO_DocUpdate *obj);
char* unfo_doc_update_from_get_u(UNFO_Object *obj);
char* unfo_doc_update_status_get(UNFO_DocUpdate *obj);
char* unfo_doc_update_status_get_u(UNFO_Object *obj);
char* unfo_doc_update_type_get(UNFO_DocUpdate *obj);
char* unfo_doc_update_type_get_u(UNFO_Object *obj);
char* unfo_doc_update_id_get(UNFO_DocUpdate *obj);
char* unfo_doc_update_id_get_u(UNFO_Object *obj);
char* unfo_doc_update_title_get(UNFO_DocUpdate *obj);
char* unfo_doc_update_title_get_u(UNFO_Object *obj);
char* unfo_doc_update_version_get(UNFO_DocUpdate *obj);
char* unfo_doc_update_version_get_u(UNFO_Object *obj);
char* unfo_doc_update_rights_get(UNFO_DocUpdate *obj);
char* unfo_doc_update_rights_get_u(UNFO_Object *obj);
char* unfo_doc_update_summary_get(UNFO_DocUpdate *obj);
char* unfo_doc_update_summary_get_u(UNFO_Object *obj);
char* unfo_doc_update_description_get(UNFO_DocUpdate *obj);
char* unfo_doc_update_description_get_u(UNFO_Object *obj);
char* unfo_doc_update_solution_get(UNFO_DocUpdate *obj);
char* unfo_doc_update_solution_get_u(UNFO_Object *obj);
