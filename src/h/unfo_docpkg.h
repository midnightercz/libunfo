...
void unfo_doc_pkg_create(UNFO_DocPkg* docpkg);
void unfo_doc_pkg_create_u(UNFO_Object* uobj);
...
int unfo_doc_pkg_name_set(UNFO_DocPkg *obj, char *val);
int unfo_doc_pkg_version_set(UNFO_DocPkg *obj, char *val);
int unfo_doc_pkg_release_set(UNFO_DocPkg *obj, char *val);
int unfo_doc_pkg_epoch_set(UNFO_DocPkg *obj, char *val);
int unfo_doc_pkg_src_set(UNFO_DocPkg *obj, char *val);
int unfo_doc_pkg_filename_set(UNFO_DocPkg *obj, char *val);
int unfo_doc_pkg_sum_set(UNFO_DocPkg *obj, char *val);
